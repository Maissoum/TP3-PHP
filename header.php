    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarColor03">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button"
                        aria-haspopup="true" aria-expanded="false"> <i class="fa-solid fa-child"></i> Gestion des auteurs</a>
                    <div class="dropdown-menu">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="listeNationalité.php">listes les nationalités </a>
                        <a class="dropdown-item" href="listeNationalité.php">Ajouter une nationalités</a>
                    </div>
                </li>
            </ul>
            ²
