...
<h2 class= "pt-3 text-center">Ajouter une nationalité</h2>
    <form action="valideAjoutNationalite.php" method="post" class="col-md-6 offset-md-3 border border-secondary p-3 rounded">
        ...
        <div class="row">
            ...
            <div class="col"><button type='submit' class='btn btn-success btn-block'>Ajouter</div>
